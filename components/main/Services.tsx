        ...
        <>
            <div className="flex flex-wrap mx-[-15px] max-sm:!mt-[-50px] !mt-[-80px] xl:mx-[-7.5px] lg:mx-[-7.5px] items-center !mb-[4.5rem] md:!mb-[7rem] lg:!mb-[9rem] xl:!mb-[9rem]">
                <div className="md:w-8/12 lg:w-6/12 xl:w-6/12 w-full flex-[0_0_auto] max-w-full relative mt-[80px]">
                    {/* Play Button */}
                    <a
                        className="btn btn-circle btn-primary !text-white !bg-[#3f78e0] border-[#3f78e0] hover:text-white hover:bg-[#3f78e0] hover:!border-[#3f78e0] active:text-white active:bg-[#3f78e0] active:border-[#3f78e0] disabled:text-white disabled:bg-[#3f78e0] disabled:border-[#3f78e0] btn-play ripple mx-auto mb-5 absolute xl:!text-[2.3rem] text-[calc(1.355rem_+_1.26vw)] w-[3.5rem] h-[3.5rem] inline-flex items-center justify-center leading-none p-0 rounded-full before:content-[''] before:block before:absolute before:opacity-80 before:animate-[ripple-1_2s_infinite_ease-in-out] before:z-[-1] before:rounded-full before:inset-0 before:bg-[#3f78e0] after:opacity-60 after:animate-[ripple-2_2s_infinite_ease-in-out] after:content-[''] after:block after:absolute after:z-[-1] after:rounded-full after:inset-0 after:bg-[#3f78e0] after:[animation-delay:.5s]"
                        style={{
                            top: '50%',
                            left: '50%',
                    ...
                    {/* Red Background Box */}
                    <div className=" hidden md:block bg-[#edf2fc] w-[85%] h-[90%] absolute bottom-[-1.8rem] right-0 z-[1]" data-rellax-speed={0}></div>

                    {/* Image */}
                    <figure className="rounded-[.4rem] relative z-[2]">
                        <Image className="rounded-[.4rem]" src="/assets/images/photos/about12.jpg" alt="image" width={750} height={520} />
                    </figure>
                </div>
