                      ...
                      <div key={index}>
                        <div className={`flex items-start gap-3 ${message.fromUserId === selectedUser.userId ? 'justify-start' : 'justify-end'}`}>
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center gap-3">
                              <div
                                className={`rounded-md bg-black/10 p-4 py-2 dark:bg-gray-800 ${
                                  message.fromUserId === selectedUser.userId ? 'ltr:rounded-bl-none rtl:rounded-br-none' : '!bg-primary text-white ltr:rounded-br-none rtl:rounded-bl-none'
                                }`}
                              >
                                {message.text}
                              </div>
                            ...
                            <div className={`text-xs text-white-dark ${message.fromUserId === selectedUser.userId ? '' : 'ltr:text-right rtl:text-left'}`}>{message.time}</div>
                          </div>
                        </div>
                      </div>
                    ))
