...
export default function Page() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      Cookies.set("current_user", JSON.stringify(result.current_user), { expires: 7 });
      Cookies.set("csrf_token", result.csrf_token, { expires: 7 });
      Cookies.set("logout_token", result.logout_token, { expires: 7 });
