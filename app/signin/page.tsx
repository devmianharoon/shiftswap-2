...
//   title:
//     "Signin || Sandbox - Modern & Multipurpose React Next.js Template with Tailwind CSS",
//   description:
...
//           navClass="flex items-center justify-between w-full lg:flex-row flex-col absolute top-0 left-0 z-50 bg-transparent xl:pt-[6px] lg:pt-[6px]"
//         />
//         <section
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 bg-white shadow-sm">
        ...
        <div className="flex gap-3">
          <button className="px-6 py-2 border border-gray-300 text-gray-700 rounded-full hover:bg-gray-50 hover:border-gray-400 transition-all duration-200">
            Login
          </button>
        ...
        <div className="bg-gradient-to-br from-blue-100 via-purple-50 to-pink-100 flex flex-col items-center justify-center px-4 py-12 min-h-[50vh]">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg font-medium hover:shadow-lg transform hover:scale-105 transition-all duration-200"
              >
                Sign In
              </button>
            </form>
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <div className="flex">
                  ...
                  />
                  <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-r-lg hover:shadow-lg transition-all duration-200">
                    Submit
                  </button>
                </div>
              </div>
