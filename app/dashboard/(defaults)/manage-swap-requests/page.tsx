...
import DummyFormComp from '../my-swap-requests/DummyFormComp';

const data = [
    { id: 102, requested_by: 'John Smith', claimed_by:"Martin Joe", original_shift: '12 June, 9am–5pm', requested_shift: '14 June, 9am–5pm', status: 'Pending' },
    { id: 103, requested_by: 'Sarah Wilson', claimed_by:"Martin Joe", original_shift: '15 June, 2pm–10pm', requested_shift: '16 June, 9am–5pm', status: 'Approved' },
    { id: 104, requested_by: 'Mike Johnson', claimed_by:"Martin Joe", original_shift: '18 June, 6am–2pm', requested_shift: '20 June, 10pm–6am', status: 'Rejected' },
    { id: 105, requested_by: 'Emma Davis', claimed_by:"Martin Joe", original_shift: '22 June, 9am–5pm', requested_shift: '24 June, 2pm–10pm', status: 'Pending' },
    { id: 106, requested_by: 'David Lee', claimed_by:"Martin Joe", original_shift: '25 June, 6am–2pm', requested_shift: '27 June, 2pm–10pm', status: 'Pending' },
    { id: 107, requested_by: 'Olivia Brown', claimed_by:"Martin Joe", original_shift: '28 June, 9am–5pm', requested_shift: '30 June, 10pm–6am', status: 'Approved' },
    { id: 108, requested_by: 'James White', claimed_by:"Martin Joe", original_shift: '1 July, 6am–2pm', requested_shift: '3 July, 2pm–10pm', status: 'Rejected' },
    { id: 109, requested_by: 'Linda Green', claimed_by:"Martin Joe", original_shift: '4 July, 9am–5pm', requested_shift: '6 July, 10pm–6am', status: 'Pending' },
    { id: 110, requested_by: 'Robert Hall', claimed_by:"Martin Joe", original_shift: '7 July, 6am–2pm', requested_shift: '9 July, 2pm–10pm', status: 'Approved' },
    { id: 111, requested_by: 'Sophia Scott', claimed_by:"Martin Joe", original_shift: '10 July, 9am–5pm', requested_shift: '12 July, 2pm–10pm', status: 'Pending' },
    { id: 112, requested_by: 'Henry King', claimed_by:"Martin Joe", original_shift: '13 July, 6am–2pm', requested_shift: '15 July, 9am–5pm', status: 'Rejected' },
];
  ...
  return (
    <div className="w-full p-4">
            ...
            <div className="flex justify-between py-4 items-center border-b">
                <h2 className="text-[28px]">Manage Swap Requests</h2>
                    ...
                    paginatedData.map((item, index) => (
                        <div key={index} className="w-[32%] max-w-[20rem] bg-white shadow rounded border p-5 dark:bg-[#191e3a]">
                            ...
                            <div className="flex gap-2 mt-4">
                                ...
                                <button className="btn btn btn-danger text-sm ">Reject</button>
                            </div>
                        </div>
                    ))
                )}
